...
const MAIL_T = {
  pl: {
    ...
    bodyMaybe:    'mamy twoje rsvp. czekamy na ostateczną decyzję – daj znać do końca czerwca.',
    ...
    introMaybe:   'czekamy na ostateczną decyzję – postaraj się dać znać do końca czerwca, żebyśmy mogli domknąć listę.',
  ...
  en: {
    ...
    bodyMaybe:    'we have your rsvp. waiting for your final answer – please let us know by end of june.',
    summary:      'summary:',
    summaryHead:  'summary',
    rowName:      'name',
    rowAttending: 'reply',
    ...
    introMaybe:   'we\'re waiting for your final answer – please try to let us know by end of june so we can close the list.',
